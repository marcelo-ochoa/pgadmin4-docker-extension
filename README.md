...
```bash
$ docker extension install mochoa/pgadmin4-docker-extension:7.2.0
Extensions can install binaries, invoke commands and access files on your machine.
Are you sure you want to continue? [y/N] y
Image not available locally, pulling mochoa/pgadmin4-docker-extension:7.2.0...
Installing new extension "mochoa/pgadmin4-docker-extension:7.2.0"
...
```bash
$ docker extension uninstall mochoa/pgadmin4-docker-extension:7.2.0
