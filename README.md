...
When monitor indicator is green just click on **Launch PGAdmin4 Tool** link and you will see PGAdmin4 window. You can also click on ![pgAdmin](pgadmin.svg?raw=true) icon at the top left of the extension main window.
